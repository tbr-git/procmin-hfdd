...
import org.processmining.emdapplications.hfdd.data.csgraph.PerspectiveCSConditionResidual;
...
public class CSVertexConditionedResidualMeasurer<T extends CVariant> extends CSVertexMeasurerBase<T> {
